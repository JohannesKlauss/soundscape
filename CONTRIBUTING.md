...
*(This document is heavily inspired by the great contribution guide of [Mario Zechners](https://github.com/badlogic) [pi coding agent](https://github.com/badlogic/pi-mono/blob/main/CONTRIBUTING.md))*
...
If you use an agent, run it from the `soundscape` root directory so it picks up `AGENTS.md` automatically. Your agent must follow the rules and guidelines in that file.
